...
Algoritmo di ottimizzazione basato su euristiche che assegna automaticamente il miglior posto disponibile in base a:
- Distanza dall’uscita;
- Tipo di utente (abbonato, disabile, VIP);
- Minimizzazione degli spostamenti interni;
- Distribuzione uniforme dei veicoli.

L’app web o un display può guidare l’utente verso il posto ottimale con un percorso calcolato tramite algoritmi.

Il sistema:
- Evita zone congestionate;
- Propone il percorso più rapido o più sicuro;
- Assegna dinamicamente il percorso in caso di manutenzione.

Un tool per gli operatori che simula:
- Scenari di affluenza
- Impatto delle manutenzioni
- Variazioni tariffarie
- Prognosi dell’occupazione
