...
class PrenotazioneServiceImplTest {
    ...
    void getStoricoUtenteTest() {
        LocalDateTime dataCreazione1 = LocalDateTime.of(2025, 1, 1, 10, 0);
        LocalDateTime dataCreazione2 = LocalDateTime.of(2025, 1, 1, 11, 0);

        Prenotazione p1 = new Prenotazione("u1", "park1", dataCreazione1, "QR1");
        p1.setId("p1");

        Prenotazione p2 = new Prenotazione("u1", "park2", dataCreazione2, "QR2");
        p2.setId("p2");
        ...
        assertEquals(dataCreazione1, result.get(0).dataCreazione());
        ...
        assertEquals(dataCreazione2, result.get(1).dataCreazione());
